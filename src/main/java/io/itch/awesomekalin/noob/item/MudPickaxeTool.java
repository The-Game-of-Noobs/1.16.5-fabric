...
public class MudPickaxeTool {
	public static final ToolMaterial MUDPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(MUDPICKAXE_TOOL_MATERIAL, 0, (float) -3,
